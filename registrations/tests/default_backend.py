...
from registrations.backends.default.views import RegistrationView
from registrations.models import RegistrationProfile


class DefaultBackendViewTests(TestCase):
    """
    Test the default registrations backend.
    ...
    """
    urls = 'registrations.backends.default.urls'
    ...
    def test_allow(self):
        ...
        whether registrations is permitted.
        ...
        # the 'registrations is closed' message.
        resp = self.client.get(reverse('registration_register'))
    ...
    def test_registration_get(self):
        """
        HTTP ``GET`` to the registrations view uses the appropriate
        template and populates a registrations form into the context.
    ...
    def test_registration(self):
        ...
        # A registrations profile was created, and an activation email
        # was sent.
    ...
    def test_activation_expired(self):
        ...
        self.assertEqual(200, resp.status_code)
        self.assertTemplateUsed(resp, 'registrations/activate.html')
