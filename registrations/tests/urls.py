...
from registrations.views import activate
...
urlpatterns = patterns('',
                       ...
                       url(r'^activate-with-template-name/(?P<activation_key>\w+)/$',
                           activate,
                           {'template_name': 'registrations/test_template_name.html',
                            'backend': 'registrations.backends.default.DefaultBackend'},
                       ...
                       url(r'^custom-success/$',
                           direct_to_template,
                           {'template': 'registrations/test_template_name.html'},
                           name='registration_test_custom_success_url'),
                       (r'', include('registrations.backends.default.urls')),
                       )
